...
@InputType()
class InventoryCreateNestedManyWithoutRawMaterialsInput {
...
export { InventoryCreateNestedManyWithoutRawMaterialsInput as InventoryCreateNestedManyWithoutRawMaterialsInput };
